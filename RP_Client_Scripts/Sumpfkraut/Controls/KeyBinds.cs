...
namespace GUC.Scripts.Sumpfkraut.Controls
{
    public class KeyBind
    {
        ...
        public static readonly KeyBind MoveForward = new KeyBind("MoveForward", VirtualKeys.W, VirtualKeys.Up);
        public static readonly KeyBind MoveLeft = new KeyBind("MoveLeft", VirtualKeys.A);
        public static readonly KeyBind MoveRight = new KeyBind("MoveRight", VirtualKeys.D);
        public static readonly KeyBind MoveBack = new KeyBind("MoveBack", VirtualKeys.S, VirtualKeys.Down);
        public static readonly KeyBind Action = new KeyBind("Action", VirtualKeys.Control, VirtualKeys.LeftButton);
        public static readonly KeyBind Jump = new KeyBind("Jump", VirtualKeys.Menu);
        public static readonly KeyBind Inventory = new KeyBind("Inventory", VirtualKeys.Tab, VirtualKeys.I);
        public static readonly KeyBind TurnLeft = new KeyBind("TurnLeft", VirtualKeys.Q, VirtualKeys.Left);
        public static readonly KeyBind TurnRight = new KeyBind("TurnRight", VirtualKeys.E, VirtualKeys.Right);
        public static readonly KeyBind DrawWeapon = new KeyBind("DrawWeapon", VirtualKeys.Space);
        public static readonly KeyBind DrawFists = new KeyBind("DrawFists", VirtualKeys.OEM5);
        public static readonly KeyBind ChatAll = new KeyBind("ChatAll", VirtualKeys.T, VirtualKeys.Return);
        public static readonly KeyBind ChatTeam = new KeyBind("ChatTeam", VirtualKeys.Z);
        public static readonly KeyBind ScoreBoard = new KeyBind("ScoreBoard", VirtualKeys.F1);
        public static readonly KeyBind StatusMenu = new KeyBind("StatusMenu", VirtualKeys.B, VirtualKeys.C);
