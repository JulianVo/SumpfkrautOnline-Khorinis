...
{
    internal sealed class CharCreationMenu : MenuWithViewBlocker
    {

        public event GenericEventHandler<CharCreationMenu, CharacterCreationCompletedArgs> CharacterCreationCompleted;
        ...
        void CreateNewCharacter()
        {
            ...
            CharacterCreationCompleted?.Invoke(this, new CharacterCreationCompletedArgs(info));
        }

        void PlayVoice()
        {
            string soundName = $"SVM_{voice.Choice}_SMALLTALK{Randomizer.GetInt(1, 31):00}.WAV";
